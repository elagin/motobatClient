 ...
 */
public class NewPointSerializable implements Serializable {
    ...
    public NewPointSerializable(MyApp myApp) {
    ...
    public void sendRequest() {
        ...
        if(myApp.getSession().isCloseMember()) {
            ...
            new CreatePointRequestNew(context, this, myApp.CLOSE_GROUP_ID);
        }
        else if(myApp.getSession().isOpenMember()) {
            //new CreatePointRequest(this, context, this, myApp.OPEN_GROUP_ID);
            new CreatePointRequestNew(context, this, myApp.OPEN_GROUP_ID);
        }
        else {
